    ...
    request() {
        ...
        fetch('/api/Pmrequest', {
            ...
            body: JSON.stringify(<Pmrequest>{
                type: this.type,
                positiontypes: positiontypesString, positioncategories: positioncategoriesString, sofs: sofsString, structures: structureString, structuretypes: structuretypesString, mrds: mrdsString,
                replacedbycivil: replacedbycivilNum, replacedbycivilnot: replacedbycivilnotNum, signed: signedNum, willbesigned: willbesignedNum, willbenotsigned: willbesignedNum,
                decertificate: decertificateNum, decertificateexpired: decertificateexpiredNum, displaytreeseparately: displaytreeseparatelyNum,
                ranks: ranksString, civilclasshigh: civilclasshighNum, civilclasslow: civilclasslowNum, structurecity: this.structurecity, structurerank: structurerankString,
                structureregion: structureregionString, structurestreet: this.structurestreet, replacedbycivildateavailable: replacedbycivildateavailableNum, replacedbycivildateexpired: replacedbycivildateexpiredNum, ranksexpanded: ranksexpanedNum,
                civil: civilonlyNum, notopchs: notopchsNum, structurecountmode: structurecountmodeNum, structurecountallinclusive: structurecountallinclusiveNum,
                structuresub: structuresubNum, structuresublevel: this.structuresublevel, structureselfcount: structureselfcountNum,
            }),
            credentials: 'include',
            headers: new Headers({
