...
namespace PersonnelManagement.Models
{
    public partial class User
    {
        ...
        /// </summary>
        /// <returns></returns>
        public User GetUserModel(Repository repository)
        {
            ...
            userModel.Onlyreadflagtoeditor = Onlyreadflagtoeditor;

            Rights rights = repository.RightsLocal().Values.FirstOrDefault(r => r.User == userModel.Id);
            if (rights != null)
            {
        ...
        public Rights GetRights(Repository repository)
        {
            Rights rights = repository.RightsLocal().Values.FirstOrDefault(r => r.User == Id);
            if (rights != null)
            {
                return rights;
            }
