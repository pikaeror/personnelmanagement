...
namespace PersonnelManagement.Controllers
{
    ...
    [Route("api/Rightsstructure")]
    public class RightsstructureController : Controller
    {

        private Repository repository;

        public RightsstructureController(Repository repository)
        {
        ...
        //// GET: api/Rights/Rightsstructure/5
        //[HttpGet("Position/{id}")]
